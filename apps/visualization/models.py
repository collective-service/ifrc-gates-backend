...
class CountryProfile(models.Model):
    ...
    economic_support_index_date = models.DateField(null=True, blank=True)
    ...
    new_cases_region_share_source = models.CharField(max_length=100, blank=True, null=True)
    new_cases_region_share_date = models.DateField(null=True, blank=True)
    ...
    stringency_date = models.DateField(null=True, blank=True)
    population_comment = models.CharField(max_length=1000, blank=True, null=True)
    readiness_date = models.DateField(null=True, blank=True)
    readiness_source = models.CharField(max_length=100, blank=True, null=True)
    risk_date = models.DateField(null=True, blank=True)
    risk_source = models.CharField(max_length=100, blank=True, null=True)
    vulnerability_date = models.DateField(null=True, blank=True)
    vulnerability_source = models.CharField(max_length=100, blank=True, null=True)
    response_date = models.DateField(null=True, blank=True)
    response_source = models.CharField(max_length=100, blank=True, null=True)
